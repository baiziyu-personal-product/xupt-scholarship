...
CREATE TABLE `quantify` (
  `id` int NOT NULL AUTO_INCREMENT,
  `group` varchar(120) COLLATE utf8_bin NOT NULL COMMENT '思想品德 、学术成果、 实践活动 \n',
  `category` varchar(120) COLLATE utf8_bin NOT NULL COMMENT '子分类',
  `type` varchar(120) COLLATE utf8_bin NOT NULL COMMENT '子分类中包含的细目种类',
  `score` int NOT NULL,
  `item` varchar(160) COLLATE utf8_bin NOT NULL COMMENT '具体类目',
  `info` longtext COLLATE utf8_bin,
  `create_time` datetime NOT NULL,
  `reviewer_id` int NOT NULL,
  `update_time` datetime NOT NULL,
  `effect` int NOT NULL DEFAULT '1' COMMENT '是否生效，1代表生效，0代表不生效，-1代表废弃',
  PRIMARY KEY (`id`,`reviewer_id`),
  UNIQUE KEY `id_UNIQUE` (`id`),
  KEY `q_rid_idx` (`reviewer_id`),
  CONSTRAINT `q_rid` FOREIGN KEY (`reviewer_id`) REFERENCES `reviewers` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8_bin COMMENT='得分量化表：group > category > type > item => score';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-01-28 19:53:21
